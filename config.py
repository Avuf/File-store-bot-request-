...
CHANNEL_ONE = int(os.environ.get("CHANNEL_ONE", "-1001970981731"))
CHANNEL_TWO = int(os.environ.get("CHANNEL_TWO", "-1001870020371"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1891736799").split()):
        ADMINS.append(int(x))
except ValueError:
