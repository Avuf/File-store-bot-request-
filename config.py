...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5896985949:AAEl3TRu7Ned_hyKHhzlwuYIqXCCXcBYTeM")
...
CHANNEL_ONE = int(os.environ.get("CHANNEL_ONE", "-1001968795744"))
CHANNEL_TWO = int(os.environ.get("CHANNEL_TWO", "-1001694242924"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5274370570").split()):
        ADMINS.append(int(x))
except ValueError:
