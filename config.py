...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5896985949:AAE0nMZYJ5jmOJDk-EoKCwKLjxR1ez5gvEE")
...
CHANNEL_ONE = int(os.environ.get("CHANNEL_ONE", "-1002937263439"))
CHANNEL_TWO = int(os.environ.get("CHANNEL_TWO", "-1002911467634"))
